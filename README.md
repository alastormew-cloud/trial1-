...
<body>
    <main>
        ...
        <div class="hero-top-section">
            <img src="img/Gambar Latar Belakang Dasar (Tangga & Pilar Tanpa Hiasan). ATAS.png" alt="Header Background" class="bg-template" />
            <div class="overlay-top">
                <!-- LAMPION / CHANDELIER DENGAN ANIMASI FADE-DOWN -->
                <img src="img/Screenshot_2026-08-15_221859-removebg-preview.png" alt="Chandelier" class="chandelier-img" data-aos="fade-down" data-aos-duration="1000" />
                
                <!-- LOGO MONOGRAM DENGAN ANIMASI ZOOM-IN (UKURAN DIPERBESAR VIA CSS .monogram-img) -->
                <img src="img/Gambar_Logo_Monogram_Bundar__Inisial_RN___Bingkai_Emas_.-removebg-preview.png" alt="Monogram Logo" class="monogram-img" data-aos="zoom-in" data-aos-delay="300" />
            </div>
        </div>
